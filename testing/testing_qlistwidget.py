...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QListWidget, QListWidgetItem, QLineEdit
...
if __name__ == '__main__':
    ...
    lst = ImageFileList(r'C:\Users\Public\Pictures\Wallpapers\Wallpapers', win)
