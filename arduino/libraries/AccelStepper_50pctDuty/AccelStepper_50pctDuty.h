// AccelStepper_50pctDuty.h
//
/// \mainpage AccelStepper50pctDuty library for Arduino
///
/// This is the Arduino AccelStepper50pctDuty library.
...
///
/// AccelStepper50pctDuty significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/AccelStepper50pctDuty
/// The version of the package that this documentation refers to can be downloaded 
/// from http://www.airspayce.com/mikem/arduino/AccelStepper50pctDuty/AccelStepper50pctDuty-1.59.zip
///
/// Example Arduino programs are included to show the main modes of use.
///
/// You can also find online help and discussion at http://groups.google.com/group/AccelStepper50pctDuty
...
/// with the exception that AccelStepper50pctDuty uses steps per second rather than radians per second
...
///
/// \htmlonly <form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_donations" /> <input type="hidden" name="business" value="mikem@airspayce.com" /> <input type="hidden" name="lc" value="AU" /> <input type="hidden" name="item_name" value="Airspayce" /> <input type="hidden" name="item_number" value="AccelStepper50pctDuty" /> <input type="hidden" name="currency_code" value="USD" /> <input type="hidden" name="bn" value="PP-DonationsBF:btn_donateCC_LG.gif:NonHosted" /> <input type="image" alt="PayPal — The safer, easier way to pay online." name="submit" src="https://www.paypalobjects.com/en_AU/i/btn/btn_donateCC_LG.gif" /> <img alt="" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1" border="0" /></form> \endhtmlonly
/// 
/// \par Trademarks
///
/// AccelStepper50pctDuty is a trademark of AirSpayce Pty Ltd. The AccelStepper50pctDuty mark was first used on April 26 2010 for
...
///               specifying AccelStepper50pctDuty::FULL4WIRE and friends.
...
/// \version 1.43  Added DualMotorShield example. Shows how to use AccelStepper50pctDuty to control 2 x 2 phase steppers using the 
...
///                Added new class MultiStepper that can manage multiple AccelStepper50pctDutys, 
...
///                Added new method maxSpeed() to AccelStepper50pctDuty to return the currently configured maxSpeed.<br>
...
///                AccelStepper50pctDuty::disableOutputs now sets the enable pion to OUTPUT mode if the enable pin is defined.
...
///                Improvements to efficiency of AccelStepper50pctDuty::runSpeed() as suggested by David Grayson.
...
// $Id: AccelStepper50pctDuty.h,v 1.27 2016/08/14 10:26:54 mikem Exp mikem $

#ifndef AccelStepper50pctDuty_h
#define AccelStepper50pctDuty_h
...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepper50pctDuty AccelStepper50pctDuty.h <AccelStepper50pctDuty.h>
...
/// AccelStepper50pctDuty will not have a correct 
...
class AccelStepper50pctDuty
{
public:
    /// \brief Symbolic names for number of pins.
    /// Use this in the pins argument the AccelStepper50pctDuty constructor to 
    ...
    /// AccelStepper50pctDuty::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// AccelStepper50pctDuty::FULL2WIRE (2) means a 2 wire stepper (2 pins required). 
    /// AccelStepper50pctDuty::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required). 
    /// AccelStepper50pctDuty::FULL4WIRE (4) means a 4 wire stepper (4 pins required). 
    /// AccelStepper50pctDuty::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// AccelStepper50pctDuty::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to AccelStepper50pctDuty::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a AccelStepper50pctDuty::DRIVER (interface==1), 
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a AccelStepper50pctDuty::DRIVER (interface==1), 
    ...
    AccelStepper50pctDuty(uint8_t interface = AccelStepper50pctDuty::FULL4WIRE, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5, bool enable = true);
    ...
    AccelStepper50pctDuty(void (*forward)(), void (*backward)());
...
private:
    ...
    uint8_t        _pin[4];
    /// Added variable to track if pin is high or low for implementation of nonblocking
    /// 50% duty cycle. --ibrummel
    uint8_t        _hilow[4];
    ...
    /// The target position in steps. The AccelStepper50pctDuty library will move the
...
/// Shows how to run AccelStepper50pctDuty in the simplest,
...
/// Shows how to use AccelStepper50pctDuty to control a 3-phase motor, such as a HDD spindle motor
/// using the Adafruit Motor Shield http://www.ladyada.net/make/mshield/index.html.

/// @example DualMotorShield.pde
/// Shows how to use AccelStepper50pctDuty to control 2 x 2 phase steppers using the 
